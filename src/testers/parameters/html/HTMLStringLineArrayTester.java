	...
	public static void main(String[] args) {
		...
		while ( !userInput.equalsIgnoreCase( "n" ) && !userInput.equals( "4" ) ) {
			...
			case ( "1" ):
				...
				HTMLStringLineArray htmlStringLineArray = new HTMLStringLineArray( "https://www.vrisko.gr/efimeries-farmakeion/agia-barbara/" );
			...
			case ("2"):
				...
				HTMLStringLineArray htmlStringLineArray2 = new HTMLStringLineArray();
			...
			case ("3"):
				...
				HTMLStringLineArray htmlStringLineArray3 = new HTMLStringLineArray();
